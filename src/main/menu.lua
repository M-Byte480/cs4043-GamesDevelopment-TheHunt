...
function scene:create( event )
	...
	local playButton = display.newText( sceneGroup, "Play", display.contentCenterX, 700, "/resources/fonts/1_MinecraftRegular1.otf", 35 )
	playButton:setFillColor( 0.82, 0.86, 1 )
	playButton.x = display.contentCenterX +38
	playButton.y = display.contentCenterY
	playButton:rotate(90)

	local multiplayerButton = display.newText( sceneGroup, "Multiplayer", display.contentCenterX, 545, "/resources/fonts/1_MinecraftRegular1.otf", 35 )
	...
	local highScoresButton = display.newText( sceneGroup, "High Scores", display.contentCenterX, 810, "/resources/fonts/1_MinecraftRegular1.otf", 35 )
