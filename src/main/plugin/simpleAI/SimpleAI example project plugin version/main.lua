...
local platform2 = display.newImage( mainGroup, "platform.png", halfW-350, screenH-250 )
platform2.type = "platform"
...
-- enemy instance
local enemy = SimpleAI.newAI(mainGroup, "snailWalk1.png", halfW-50, display.contentHeight-300, "patrol", sprite)
function enemy:defaultActionOnAiCollisionWithPlayer(event)
	 	enemy:remove( )
end	
-- now "enemy" will contact with "player"

-- another enemy instance
local enemy1 = SimpleAI.newAI(mainGroup, "snailWalk1.png", halfW-140, display.contentHeight-500, "patrol", sprite)
...
local enemy2 = SimpleAI.newAI(mainGroup, "snailWalk1.png", halfW-300, display.contentHeight-300, "patrol")
